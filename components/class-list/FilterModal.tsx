          ...
          >
            ...
            >
              <Button
                ...
                outline
                size='xSmall'
                color={filterLevel.includes(LEVEL.BASIC) ? myTextColor.primary : myTextColor.caption}
                onPress={() => handleLevel(LEVEL.BASIC)}
                style={{
                  borderWidth: 1,
                  borderColor: filterLevel.includes(LEVEL.BASIC) ? myTheme.primary : '#697B7A',
                  backgroundColor: filterLevel.includes(LEVEL.BASIC) ? myTheme.lightGrey : '#FFF'
                }}
                labelStyle={{ fontFamily: myFontWeight.semiBold }}
              />
              <Button
                ...
                outline
                size='xSmall'
                color={filterLevel.includes(LEVEL.INTERMEDIATE) ? myTextColor.primary : myTextColor.caption}
                onPress={() => handleLevel(LEVEL.INTERMEDIATE)}
                style={{
                  borderWidth: 1,
                  borderColor: filterLevel.includes(LEVEL.INTERMEDIATE) ? myTheme.primary : '#697B7A',
                  backgroundColor: filterLevel.includes(LEVEL.INTERMEDIATE) ? myTheme.lightGrey : '#FFF'
                }}
                labelStyle={{ fontFamily: myFontWeight.semiBold }}
              />
              <Button
                ...
                outline
                size='xSmall'
                color={filterLevel.includes(LEVEL.ADVANCED) ? myTextColor.primary : myTextColor.caption}
                onPress={() => handleLevel(LEVEL.ADVANCED)}
                style={{
                  borderWidth: 1,
                  borderColor: filterLevel.includes(LEVEL.ADVANCED) ? myTheme.primary : '#697B7A',
                  backgroundColor: filterLevel.includes(LEVEL.ADVANCED) ? myTheme.lightGrey : '#FFF'
                }}
                labelStyle={{ fontFamily: myFontWeight.semiBold }}
              />
            </View>
